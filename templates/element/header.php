...
<head>
  ...
  <!-- Morris chart -->
  <?php echo $this->Html->css('/bower_components/morris.js/morris.css'); ?>
  <!-- jvectormap -->
  <?php echo $this->Html->css('/bower_components/jvectormap/jquery-jvectormap.css'); ?>
  <!-- Date Picker -->
  <?php echo $this->Html->css('/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css'); ?>
  <!-- Daterange picker -->
  <?php echo $this->Html->css('/bower_components/bootstrap-daterangepicker/daterangepicker.css'); ?>
